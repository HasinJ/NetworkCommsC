...
We chose to allow empty key strings and empty key values, we didn't want to loop through the payload to check every character. This was the same reason we allowed empty length inputs to be 0.
